...
system:
  - "Start with a workflow map, not a bot script."
  - "Define the trigger, qualification logic, escalation rules, CRM fields, and reporting output."
  - "Use AI only where language handling improves speed or clarity."
  - "Keep human approval where policy, compliance, or judgment matters."
metrics:
