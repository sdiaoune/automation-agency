...
faqs:
  ...
  - question: "Does faster response always mean more leases?"
    answer: "Not by itself. Speed works when the response qualifies the renter, routes the next step, and keeps follow-up consistent."
...
1. Define response-time targets by channel and workflow.
2. Automate acknowledgement for missed calls, forms, and common leasing questions.
3. Escalate only the conversations that require human judgment.
4. Report response speed weekly by property, source, and hour.
