...
metrics:
  ...
  - "next-day follow-up backlog reduced"
  - "showing requests created"
...
faqs:
  ...
  - question: "What should stay human after hours?"
    answer: "Fair housing-sensitive judgment, exceptions, escalations, and complex applicant questions should be routed to trained staff."
...
1. Route after-hours calls and forms into an AI-assisted intake flow.
2. Confirm property interest, move timeline, budget, pet status, and tour preferences.
3. Offer approved next steps such as a tour request, callback window, or application link.
4. Sync the summary to the CRM before the next business day.
